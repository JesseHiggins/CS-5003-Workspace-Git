''' Jesse Higgins
    CS5001
    Brackets Stack Project - using the module copy of a stack to implement a stack that reads in open and close brackets and pops and pushes accordingly.
'''
...
def brackets():
    '''brackets - Function for testing and importing
        Params: none
        returns: none
    '''
    my_stack = Stack(5)
